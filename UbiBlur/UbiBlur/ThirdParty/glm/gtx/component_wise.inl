...
namespace glm {
    namespace detail {
        ...
        struct compute_compNormalize<T, floatType, P, vecType, true, true> {
            GLM_FUNC_QUALIFIER static vecType<floatType, P>
            call(vecType<T, P> const & v)
            {
        ...
        struct compute_compScale<T, floatType, P, vecType, true, true> {
            ...
            call(vecType<floatType, P> const & v)
            {
    ...
    GLM_FUNC_QUALIFIER vecType<floatType, P>
    ...
    return
    detail::compute_compNormalize<T, floatType, P, vecType, std::numeric_limits<T>::is_integer, std::numeric_limits<T>::is_signed>::call(v);
}
...
return
detail::compute_compScale<T, floatType, P, vecType, std::numeric_limits<T>::is_integer, std::numeric_limits<T>::is_signed>::call(v);
}
