...
namespace glm {
    namespace detail {
        ...
        GLM_FUNC_QUALIFIER length_t

        fmat4x4SIMD::length() const {
            return 4;
        }
...
// mat4 operators
    ...
    GLM_FUNC_QUALIFIER fmat4x4SIMD
    &
...
inverse(detail::fmat4x4SIMD
const & m)
{
detail::fmat4x4SIMD result;
detail::sse_inverse_ps(&m[0]
.Data, &result[0].Data);
return
result;
}
...
GLM_ALIGN(16)
mat4 Result;
_mm_store_ps(&Result[0][0], x
.Data[0].Data);
_mm_store_ps(&Result[1][0], x
.Data[1].Data);
_mm_store_ps(&Result[2][0], x
.Data[2].Data);
_mm_store_ps(&Result[3][0], x
.Data[3].Data);
return
Result;
}
...
result[0].
Data = _mm_mul_ps(c.Data, Shu0);
result[1].
Data = _mm_mul_ps(c.Data, Shu1);
result[2].
Data = _mm_mul_ps(c.Data, Shu2);
result[3].
Data = _mm_mul_ps(c.Data, Shu3);
return
result;
}

GLM_FUNC_QUALIFIER detail::fmat4x4SIMD
transpose(detail::fmat4x4SIMD
const & m)
{
detail::fmat4x4SIMD result;
glm_mat4_transpose(&m[0]
.Data, &result[0].Data);
return
result;
}
