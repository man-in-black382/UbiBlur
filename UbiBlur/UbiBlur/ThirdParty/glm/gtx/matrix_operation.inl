...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat2x3<T, P>
diagonal2x3
(
        tvec2<T, P>
const & v
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat2x4<T, P>
diagonal2x4
(
        tvec2<T, P>
const & v
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat3x2<T, P>
diagonal3x2
(
        tvec2<T, P>
const & v
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat3x4<T, P>
diagonal3x4
(
        tvec3<T, P>
const & v
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat4x3<T, P>
diagonal4x3
(
        tvec3<T, P>
const & v
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat4x2<T, P>
diagonal4x2
(
        tvec2<T, P>
const & v
