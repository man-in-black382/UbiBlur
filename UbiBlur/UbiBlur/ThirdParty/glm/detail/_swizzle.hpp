...
namespace glm {
    namespace detail {
        ...
        struct _swizzle_base1<2, T, P, vecType, E0, E1, -1, -2, Aligned> : public _swizzle_base0<T, 2> {
            ...
            operator()() const {
                return vecType < T, P > (this->elem(E0), this->elem(E1));
            }
        };
        ...
        struct _swizzle_base1<3, T, P, vecType, E0, E1, E2, -1, Aligned> : public _swizzle_base0<T, 3> {
            ...
            operator()() const {
                return vecType < T, P > (this->elem(E0), this->elem(E1), this->elem(E2));
            }
        };
        ...
        struct _swizzle_base1<4, T, P, vecType, E0, E1, E2, E3, Aligned> : public _swizzle_base0<T, 4> {
            ...
            operator()() const {
                return vecType < T, P > (this->elem(E0), this->elem(E1), this->elem(E2), this->elem(E3));
            }
        };
        ...
        */
        ...
        struct _swizzle_base2 : public _swizzle_base1<N, T, P, vecType, E0, E1, E2, E3, detail::is_aligned<P>::value> {
            ...
            operator=(vecType<T, P> const &that) {
                struct op {
                    GLM_FUNC_QUALIFIER void operator()(T &e, T &t) {
                        e = t;
                    }
                };
                _apply_op(that, op());
        ...
        struct _swizzle_base2<N, T, P, vecType, E0, E1, E2, E3, 1>
                : public _swizzle_base1<N, T, P, vecType, E0, E1, E2, E3, detail::is_aligned<P>::value> {
            struct Stub {
            };
        ...
        template<int N, typename T, precision P, template<typename, precision> class vecType, int E0, int E1, int E2, int E3>
        struct _swizzle
                : public _swizzle_base2<N, T, P, vecType, E0, E1, E2, E3, (E0 == E1 || E0 == E2 || E0 == E3 || E1 == E2 || E1 == E3 || E2 == E3)> {
            typedef _swizzle_base2<N, T, P, vecType, E0, E1, E2, E3, (E0 == E1 || E0 == E2 || E0 == E3 || E1 == E2 || E1 == E3 || E2 == E3)> base_type;

            using base_type::operator=;

            GLM_FUNC_QUALIFIER operator vecType<T, P>() const {
                return (*this)();
            }
        };
