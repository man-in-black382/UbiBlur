...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    template<typename T, precision P>
    GLM_FUNC_QUALIFIER tmat3x3 <T, P> operator+(tmat3x3 < T, P >
    const & m) {
    return
    m;
}
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat3x3<T, P>::col_type operator*(tmat3x3 < T, P >
const & m,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat2x3 <T, P> operator*(tmat3x3 < T, P >
const & m1,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat4x3 <T, P> operator*(tmat3x3 < T, P >
const & m1,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER bool operator==(tmat3x3 < T, P >
const & m1,
tmat3x3 <T, P> const &m2
)
{
