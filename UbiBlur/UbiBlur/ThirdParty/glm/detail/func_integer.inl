...
#	endif//GLM_HAS_BITSCAN_WINDOWS
    ...
    GLM_FUNC_QUALIFIER uint usubBorrow(uint const &x, uint const &y, uint &Borrow) {
        ...
        if (y >= x)
            ...
            return static_cast<uint32>((static_cast<int64>(1)
                    << static_cast<int64>(32)) + (static_cast<int64>(y) - static_cast<int64>(x)));
    }
    ...
    GLM_FUNC_QUALIFIER vecType<uint, P> usubBorrow(vecType<uint, P> const &x, vecType<uint, P> const &y, vecType<uint, P> &Borrow) {
        ...
        vecType<uint, P> const XgeY(vecType<uint32, P>((static_cast<int64>(1)
                << static_cast<int64>(32)) + (vecType<int64, P>(y) - vecType<int64, P>(x))));
