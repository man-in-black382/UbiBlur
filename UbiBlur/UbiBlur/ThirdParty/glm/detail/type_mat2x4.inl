...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    template<typename T, precision P>
    GLM_FUNC_QUALIFIER tmat2x4 <T, P> operator+(tmat2x4 < T, P >
    const & m) {
    return
    m;
}
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat2x4<T, P>::col_type operator*(tmat2x4 < T, P >
const & m,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat4x4 <T, P> operator*(tmat2x4 < T, P >
const & m1,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat3x4 <T, P> operator*(tmat2x4 < T, P >
const & m1,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER bool operator==(tmat2x4 < T, P >
const & m1,
tmat2x4 <T, P> const &m2
)
{
