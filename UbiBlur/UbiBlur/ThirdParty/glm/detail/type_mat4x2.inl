...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    template<typename T, precision P>
    GLM_FUNC_QUALIFIER tmat4x2 <T, P> operator+(tmat4x2 < T, P >
    const & m) {
    return
    m;
}
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER typename tmat4x2<T, P>::col_type operator*(tmat4x2 < T, P >
const & m,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat2x2 <T, P> operator*(tmat4x2 < T, P >
const & m1,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER tmat3x2 <T, P> operator*(tmat4x2 < T, P >
const & m1,
...
template<typename T, precision P>
GLM_FUNC_QUALIFIER bool operator==(tmat4x2 < T, P >
const & m1,
tmat4x2 <T, P> const &m2
)
{
