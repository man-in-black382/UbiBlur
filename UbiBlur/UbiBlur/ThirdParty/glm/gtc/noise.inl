...
{
tvec4 <T, P> Pi = floor(tvec4 < T, P > (Position.x, Position.y, Position.x, Position.y)) + tvec4 < T, P
>(0.0, 0.0, 1.0, 1.0);
tvec4 <T, P> Pf = fract(tvec4 < T, P > (Position.x, Position.y, Position.x, Position.y)) - tvec4 < T, P
>(0.0, 0.0, 1.0, 1.0);
...
tvec3 <T, P> Pf0 = fract(Position); // Fractional part for interpolation
tvec3 <T, P> Pf1 = Pf0 - tvec3 < T, P
>(T(1)); // Fractional part - 1.0
tvec4 <T, P> ix = tvec4 < T, P
>(Pi0.x, Pi1.x, Pi0.x, Pi1.x);
tvec4 <T, P> iy = tvec4 < T, P
...
tvec3 <T, P> g000 = tvec3 < T, P
>(gx0.x, gy0.x, gz0.x);
tvec3 <T, P> g100 = tvec3 < T, P
>(gx0.y, gy0.y, gz0.y);
tvec3 <T, P> g010 = tvec3 < T, P
>(gx0.z, gy0.z, gz0.z);
tvec3 <T, P> g110 = tvec3 < T, P
>(gx0.w, gy0.w, gz0.w);
tvec3 <T, P> g001 = tvec3 < T, P
>(gx1.x, gy1.x, gz1.x);
tvec3 <T, P> g101 = tvec3 < T, P
>(gx1.y, gy1.y, gz1.y);
tvec3 <T, P> g011 = tvec3 < T, P
>(gx1.z, gy1.z, gz1.z);
tvec3 <T, P> g111 = tvec3 < T, P
>(gx1.w, gy1.w, gz1.w);
...
//i1.y = 1.0 - i1.x;
tvec2 <T, P> i1 = (x0.x > x0.y) ? tvec2 < T, P > (1, 0) : tvec2 < T, P
>(0, 1);
// x0 = x0 - 0.0 + 0.0 * C.xx ;
// x1 = x0 - i1 + 1.0 * C.xx ;
// x2 = x0 - 1.0 + 2.0 * C.xx ;
tvec4 <T, P> x12 = tvec4 < T, P
>(x0.x, x0.y, x0.x, x0.y) +
tvec4 <T, P>(C
.x, C.x, C.z, C.z);
x12 = tvec4 < T, P
...
tvec4 <T, P> a0 = tvec4 < T, P
>(b0.x, b0.z, b0.y, b0.w) +
tvec4 <T, P>(s0
.x, s0.z, s0.y, s0.w) *
tvec4 <T, P>(sh
.x, sh.x, sh.y, sh.y);
tvec4 <T, P> a1 = tvec4 < T, P
>(b1.x, b1.z, b1.y, b1.w) +
tvec4 <T, P>(s1
.x, s1.z, s1.y, s1.w) *
tvec4 <T, P>(sh
...
dot(m
* m,
tvec4 <T, P>(dot(p0, x0), dot(p1, x1), dot(p2, x2), dot(p3, x3)
));
}
...
dot(m0
* m0,
tvec3 <T, P>(dot(p0, x0), dot(p1, x1), dot(p2, x2)
)) +
dot(m1
* m1,
tvec2 <T, P>(dot(p3, x3), dot(p4, x4)
)));
}
}//namespace glm
